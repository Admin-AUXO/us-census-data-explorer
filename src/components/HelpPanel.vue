...
.help-panel {
  ...
  animation: fadeIn var(--duration-normal) var(--easing-standard) !important;
}
...
.help-content {
  ...
  animation: slideUp var(--duration-normal) var(--easing-standard) !important;
}
